 ...
 * under the License.
 ******************************************************************************/
package org.apache.sling.scripting.sightly.apps.mysite.components.student__002d__info__002d__multi;
...
public final class student__002d__info__002d__multi__002e__html extends RenderUnit {
...
_global_studentinfo = renderContext.call("use", com.mysite.core.models.StudentInfoMultiFieldModel.class.getName(), obj());
out.write("\n\n\n<h4>");
{
...
out.write("</h3>\n\n");
{
    Object var_collectionvar2 = renderContext.getObjectModel().resolveProperty(_global_studentinfo, "multifield");
    {
            ...
            if (var_notempty4) {
                {
                    long var_end7 = var_size3;
                    {
                        ...
                        if (var_validstartstepend8) {
                            ...
                            long var_index9 = 0;
                            for (Object hobbies : var_collectionvar2_list_coerced$) {
                                {
                                    boolean var_traversal11 = (((var_index9 >= 0) && (var_index9 <= var_end7)) && true);
                                    if (var_traversal11) {
                                        out.write("\n\tHobby::</br><li>");
                                        {
                                            Object var_12 = renderContext.call("xss", renderContext.getObjectModel().resolveProperty(hobbies, "hobby"), "text");
                                            out.write(renderContext.getObjectModel().toString(var_12));
                                        }
                                        out.write("</li>\n    Interest::</br><li>");
                                        {
                                            Object var_13 = renderContext.call("xss", renderContext.getObjectModel().resolveProperty(hobbies, "interest"), "text");
